...
import ProjectTestcases.UtilitiFunctions;

public class SCF_UserPostAssessment extends LaunchBrowser {

	public XLUtilites xlutil;
	public UtilitiFunctions utility;
	...
	String SheetQA = "SCF_PostAssessment";
	String SheetUsers = "SCF_User";

	Map<String, Integer> rowmap = new HashMap<String, Integer>();

	@Test(dataProvider = "PostAssessment", description = "Complete the Post the Assessment process")
	public void CourseSCF_PostAssessment(String Username, String Password, String CourseforPostAssessment)
			throws Exception {
