...
public class CTMA2_UserPostAssessment extends LaunchBrowser {
	...
	String SheetQA = "CTMA_PostAssessment";
	String SheetUsers = "CTMA_User";

	Map<String, Integer> rowmap = new HashMap<String, Integer>();

	// String DownloadFileName, String FeedbackExported_Date
	//
	@Test(dataProvider = "PostAssessment", description = "Complete the Post the Assessment process")
	public void CourseCTMA_PostAssessment(String Username, String Password, String CourseforPostAssessment)
			throws Exception {
		...
		// Click on the Second Intermediate PostAssessment
		driver.findElement(By.xpath("(//li[@class='activity quiz modtype_quiz ']/div/div)[2]/div[2]/div/a")).click();
