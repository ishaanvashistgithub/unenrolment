...
public class CKYCA2_UserPostAssessment extends LaunchBrowser {
	...
	String SheetQA = "CKYCA_PostAssessment";
	String SheetUsers = "CKYCA_User";

	Map<String, Integer> rowmap = new HashMap<String, Integer>();

	@Test(dataProvider = "PostAssessment", description = "Complete the Post the Assessment process")
	public void CourseCKYCA_PostAssessment(String Username, String Password, String CourseforPostAssessment)
			throws Exception {
