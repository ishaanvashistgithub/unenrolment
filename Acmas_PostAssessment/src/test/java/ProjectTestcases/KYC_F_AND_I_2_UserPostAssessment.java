...
public class KYC_F_AND_I_2_UserPostAssessment extends LaunchBrowser {
...
//	XSSFSheet sheet;
	...
	public void CourseKYCFandI_PostAssessment(String Username, String Password, String CourseforPostAssessment)
		...
		// Comelete condtion first scrom file need to checked
		pageFunctions.ClickonScromFile2ndFOR_KYCFI(driver);

		driver.navigate().back();

		// Click on the Second Intermediate PostAssessment
		
		pageFunctions.ClickIntermediatePostAssessment_2_for_nonFoundational(driver);
